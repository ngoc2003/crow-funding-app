...
const Sidebar = () => {
  return (
    ...
    <div className="flex flex-col items-center ">
      ...
      <Gap></Gap>
      <div className="px-[14px] items-center w-full bg-white shadow-[10px_10px_20px_rgba(218, 213, 213, 0.15)] rounded-xl md:w-20 py-10 flex gap-y-7 flex-col ">
        {sidebarLinks.map((item) => {
          return item.url ? (
            ...
            ${
              isActive
                ? "bg-active text-primary iconNav--active p-3"
                : "hover:bg-lite p-0"
            }
          `}
            >
